...
export const api = {
  ...
  shorts: (userId) => axios.get(`${BASE_URL}/api/shorts`, { params: { user_id: userId } }),
  unlock: (userId, stateLevel) => axios.post(`${BASE_URL}/api/shorts/unlock`, { user_id: userId, state_level: stateLevel }),
  markWatched: (episodeNo, userId) => axios.post(`${BASE_URL}/api/shorts/watched`, { episode_no: episodeNo, user_id: userId }),
